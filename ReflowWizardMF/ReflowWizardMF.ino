...
*
* Temperature (Degree Celsius)                 Magic Happens Here!
* 245-|                                               x  x  
*     |                                            x        x
*     |                                         x              x
*     |                                      x                    x
...
void setup() {
  ...
  Serial.println(F("ControLeo2 Reflow Oven controller v1.5c"));
...
#else //BAKE addition makes 4 options
boolean (*action[NO_OF_MODES])() = {Testing, Config, Reflow, Bake};
const char* modes[NO_OF_MODES] = {"Test Outputs?", "Setup?", "Start Reflow?", "Bake?"};
#endif //BAKE
